...
public class Complex {
	 ...
	 * use the conjugate of the denominator, and simplifies like so:
	 * 
	 * <pre>
	 * a + bi
	 * ------
	...
	public Complex divide(Complex other) {
		double ccdd = Math.pow(other.real, 2) + Math.pow(other.imag, 2);
		return new Complex((this.real * other.real + this.imag * other.imag) / ccdd,
				(this.imag * other.real - this.real * other.imag) / ccdd);
	}
}
